...
/**
 * Download files (all or increment) from Google Cloud.
 */
class GoogleCloudProvider(synchronize: Boolean, context: AppCompatActivity, r: Resources, factory: IndexWriterFactory):
        AbstractCloudProvider<Void, Int, DropboxCloudProvider.SyncResult>(synchronize, context, r, factory) {

    override fun onPreExecute() {
        println("Start synchronization with Google Cloud using ${getToken()}!")
    }
